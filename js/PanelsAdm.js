jQuery(function($) {
			...
			function Activar($id){
			 ...
			 function Empresas(){
				   ...
				   $.post('Adm_Empresa.php',{},function(datitos){$("#IdCuerpo").html(datitos); })  }
			 function Medicos(){
				$grupo=$("#HiNombreGrupo").val();
			 ...
			 function ReporCierreCaja(){  $.post('ReporteCierresCaja.php',{},function(datitos){$("#IdCuerpo").html(datitos); })  } 
