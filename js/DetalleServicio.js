...
$("#table-detalleservicio").dataTable({
    ...
    "ajax":
            {
                url: 'controlador/Cdetalleservicio.php?op=listar&servicio='+$("#servicio").val(),
                type: "POST",
                dataType: "json",
                error: function (e) {
...
$("#formEditar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Cdetalleservicio.php?op=editar',
        type: "POST",
        data: {id: $("#eid").val(), nombre: $("#enombre").val()},

        success: function (data) {
            $('#ModalEditar').modal('hide');
            $('#table-detalleservicio').DataTable().ajax.reload();
            console.log(data);
            if (data == 1) {
...
$("#formRegistrar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Cdetalleservicio.php?op=registrar',
        type: "POST",
        data: {
            nombre: $("#rnombre").val(),servicio:$("#servicio").val()
        },
...
$("#formEliminar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Cdetalleservicio.php?op=eliminar',
        type: "POST",
