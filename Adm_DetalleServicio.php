...
<?php include('cado/ClaseServicio.php') ?>
<input type="hidden" id="servicio" readonly="" value="<?= $_POST["servicio"] ?>"  />
<!--Detalle servicio -->
<script src="js/DetalleServicio.js"></script>
<div class="page-header"  style="background-color:#EFF3F8; margin:0">
    <h1><i class="menu-icon"><img src="imagenes/convenio.png" style="border:0;"  height="25" width="25" ></i>
        <span id="Titulo" style="font-size:13px; font-weight:bold">DETALLES DEL SERVICIO :

            <?php
            $oservicio = new Servicio();
            $lista = $oservicio->nombre($_POST["servicio"]);
            $nombre = " - ";
...
<div class="bodycontainer scrollable ">
    <table id="table-detalleservicio" class="table table-responsive table-bordered text-center" style="margin:0" >
        <thead> 
            <tr >
                <Th class='center' width=''>N°</Th>
                <Th class="center" width="">Descripción</Th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p >¿Está seguro de eliminar esta detalle?</p>
            </div>
